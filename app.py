...
# ==============================================================================
# [GIAE KERNEL SHIELD v57.23 - ANTI-FLICKER EDITION]
# ==============================================================================
...
# 2. BLOCO DE ESTABILIZAÇÃO AGRESSIVA (RESOLVE O PISCAR)
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700;900&display=swap');
    
    /* [SOLUÇÃO TÉCNICA] DESATIVA TODAS AS ANIMAÇÕES DE RECARREGAMENTO DO STREAMLIT */
    * {
    ...
    /* ESCONDE A LINHA DE CARREGAMENTO NO TOPO */
    [data-testid="stHeader"] { display: none !important; }
    div[data-testid="stProgress"] { display: none !important; }

    /* FIXA O CABEÇALHO COM PRIORIDADE DE HARDWARE */
    .betano-header { 
        position: fixed; 
        ...
        z-index: 9999999; 
        transform: translate3d(0,0,0); /* Trava o elemento na GPU */
    }
    
    /* REGRAS DE LAYOUT MANTIDAS */
