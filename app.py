...
# ==============================================================================
# [SISTEMA JARVIS - VERSÃO FINAL BLINDADA - ORÁCULO ATIVO]
# ==============================================================================

# CHAVE DE API QUE VOCÊ ENVIOU (JÁ CONFIGURADA)
CHAVE_GOOGLE = "AIzaSyC83QqObkFM5QaJfVrivAmdqIp1ruWHo-4"

def pesquisar_oraculo(pergunta):
    try:
        # Configura o cérebro da Inteligência Artificial
        genai.configure(api_key=CHAVE_GOOGLE)
        model = genai.GenerativeModel('gemini-1.5-flash')
        
        # Prompt otimizado para traders esportivos
        prompt = f"Aja como o Oráculo Jarvis. Responda de forma clara, curta e profissional para um trader: {pergunta}"
        response = model.generate_content(prompt)
        return response.text
    except Exception as e:
        return "⚠️ O Oráculo está recebendo muitas consultas. Por favor, tente clicar no botão novamente em 5 segundos."
...
# ==============================================================================
# 2. CAMADA DE ESTILO CSS (ALTO CONTRASTE - SEU LAYOUT ORIGINAL PRESERVADO)
# ==============================================================================
st.markdown("""
    <style>
    ...
    /* BOTÃO DE EXECUÇÃO LARGO E COLORIDO - ALTA VISIBILIDADE */
...
if st.session_state.aba_ativa == "home":
    ...
    st.write("Aguardando novas análises da IA...")
    ...
    # Campo de Pergunta
    pergunta = st.text_input("DIGITE SUA PERGUNTA ABAIXO:", placeholder="Ex: Quem ganhou o último clássico entre Flamengo e Vasco?")
            ...
            with st.spinner("O Oráculo está processando..."):
                ...
                st.markdown(f"""
                    <div class="kpi-detailed-card" style="border-left: 5px solid #9d54ff; margin-top: 25px;">
                        <div style="color:#9d54ff; font-size:13px; font-weight:900; margin-bottom:12px;">RESPOSTA DO ORÁCULO:</div>
