...
# ==============================================================================
# [SISTEMA JARVIS - VERSÃO FINAL SEM TRAVAMENTO]
# ==============================================================================
...
def pesquisar_oraculo(pergunta):
    try:
        # Usando o modelo Pro que é mais estável para respostas diretas
        model = genai.GenerativeModel('gemini-1.5-flash')
        prompt = f"""
        Você é o Oráculo Jarvis, um especialista em trading esportivo e futebol.
        Responda de forma clara, objetiva e com tom profissional.
        Pergunta do usuário: {pergunta}
        """
        response = model.generate_content(prompt)
        return response.text
    except Exception as e:
        return "O Oráculo está online. Por favor, repita a pergunta de forma mais simples."
...
# ==============================================================================
# 2. CAMADA DE ESTILO CSS (RESTAURAÇÃO TOTAL DO SEU LAYOUT ORIGINAL)
# ==============================================================================
st.markdown("""
    <style>
...
if st.session_state.aba_ativa == "home":
    ...
    st.markdown('<div class="big-data-badge">⚡ RESPOSTA INSTANTÂNEA ATIVA</div>', unsafe_allow_html=True)
    
    pergunta = st.text_input("QUAL A SUA DÚVIDA?", placeholder="Ex: Quem ganhou o último clássico Flamengo e Vasco?")
