...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v75.0 - RESTAURAÇÃO DE LAYOUT INTEGRAL]
# DIRETRIZ 1: HEADER NA SIDEBAR (TRAVA DE CICLO)
# DIRETRIZ 2: MANTER TRANSLATE3D E BACKFACE-VISIBILITY (TRAVA DE GPU)
# DIRETRIZ 3: NAVEGAÇÃO APENAS POR SESSION_STATE (ESTABILIDADE)
# DIRETRIZ 4: ESTILIZAÇÃO PRIORITÁRIA (ZERO WHITE REFORÇADO)
# DIRETRIZ 5: CÓDIGO 100% ÍNTEGRO - TODAS AS FUNÇÕES CONFORME IMAGENS 1-6
# ==============================================================================
    ...
    if len(vips) < 20:
        ...
        for i in range(len(vips), 20):
            vips.append({
                ...
                "V": "68% (PROB)", "G": "OVER 1.5 (HT/FT)", "CT": "4.5 total", "E": "9.5 total", "TM": "14+ total", "CH": "9+ total", "DF": "7+ total"
            })
...
st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | v75.0</div><div>JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
