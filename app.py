...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v76.0 - INTEGRIDADE TOTAL - CORREÇÃO DE SINTAXE]
...
st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | v76.0</div><div>JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
