...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v69.00 - RESTAURAÇÃO TOTAL DA UI EM PORTUGUÊS]
# ==============================================================================
...
# 2. CAMADA DE ESTILO CSS (100% FIEL À IMAGEM 1)
st.markdown("""
    <style>
    ...
    * { -ms-overflow-style: none !important; scrollbar-width: none !important; }
    ...
    .bilhete-master { background: #ffffff !important; color: #111 !important; padding: 25px; border-radius: 2px; font-family: 'Courier New', monospace; max-width: 480px; margin: 0 auto; border-top: 10px solid #9d54ff; }
...
# 3. HEADER SUPERIOR (COMO NA IMAGEM 1)
with st.sidebar:
    st.markdown("""
    ...
    # BOTÕES DA SIDEBAR (LISTA COMPLETA DA IMAGEM 1)
...
if st.session_state.aba_ativa == "home":
    ...
    with c4: draw_card("SISTEMA", "JARVIS v69.00", 100)
...
st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | v69.00</div><div>JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
