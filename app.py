...
def executar_scanner_live():
    ...
    path_live = "https://raw.githubusercontent.com/Aritonapr/gestor-ia-apostas/main/data/base_jogos_jarvis.csv"
    novos_jogos = []
    
    try:
        df_live = pd.read_csv(f"{path_live}?v={datetime.now().timestamp()}", on_bad_lines='skip')
...
if st.session_state.aba_ativa == "home":
    ...
    lista_base = ["Flamengo", "Palmeiras", "Real Madrid", "Man City", "Arsenal", "Barcelona"]
    ...
    if st.button("⚡ EXECUTAR ALGORITIMO", use_container_width=True):
        ...
        st.session_state.analise_bloqueada = {
            ...
            "luz": "🟢", "motivo": "BIG DATA REAL", "cor": "#00ff88"
        }
