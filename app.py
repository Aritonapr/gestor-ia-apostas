...
if st.session_state.aba_ativa == "analise":
    ...
    db_hierarquia = {"🇧🇷 BRASIL": {"Ligas Nacionais": ["BRASILEIRÃO SÉRIE A"]}, "🌎 INTERNACIONAIS": {"Ligas Europeias": ["PREMIER LEAGUE"]}}
    ...
    if st.button("⚡ EXECUTAR ALGORITIMO", use_container_width=True):
        st.session_state.analise_bloqueada = {"liga": sel_camp, "casa": "Time A", "fora": "Time B", "vencedor": "CASA", "gols": "OVER 1.5", "stake": "R$ 10.00", "cantos": "9.5+", "data": datetime.now().strftime("%H:%M")}
