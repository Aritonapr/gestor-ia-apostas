...
# ==============================================================================
# [GIAE KERNEL SHIELD v42.2 - EFEITO BOTÃO EXECUTAR]
# ==============================================================================
...
st.markdown("""
    ...
    /* [NOVO EFEITO] BOTÃO EXECUTAR ALGORITIMO */
    div.stButton > button {
    ...
    [data-testid="stSidebar"] button {
        background-color: transparent !important; color: #94a3b8 !important; border-bottom: 1px solid #1a202c !important; 
        text-align: left !important; width: 100% !important; padding: 18px 25px !important; font-size: 10px !important; 
    }
...
if st.session_state.aba_ativa == "home":
    ...
    for h in [h5, h6, h7, h8]:
        with h: st.markdown('<div class="highlight-card"><div style="color:#64748b; font-size:9px;">Scanner IA</div><div style="color:white; font-size:16px; font-weight:900; margin-top:10px;">PROCESSANDO</div><div class="conf-bar-bg"><div class="conf-bar-fill" style="width:60%;"></div></div></div>', unsafe_allow_html=True)
...
# --- TELA: ANÁLISE MÉTRICA ---
    ...
    if st.session_state.analise_pronta:
        ...
        for r in [r5, r6, r7, r8]:
            with r: st.markdown(f'<div class="highlight-card"><div style="color:#64748b; font-size:9px;">EXTRA</div><div style="color:white; font-size:14px; font-weight:900; margin-top:10px;">DADOS IA</div><div class="conf-bar-bg"><div class="conf-bar-fill" style="width:90%;"></div></div></div>', unsafe_allow_html=True)

# --- FOOTER ---
st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | KEY: GIAE-V17-ELITE-RECOVERY</div><div>GESTOR IA PRO v42.2 | JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
