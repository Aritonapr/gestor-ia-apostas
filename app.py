...
# ==============================================================================
# [GIAE KERNEL SHIELD v57.23 - FULL RESTORED & ANTI-FLICKER]
...
# 2. ISOLAMENTO DO CABEÇALHO E CSS (ESTABILIZADO)
st.markdown("""
    <style>
    ...
    /* HEADER FIXO - GESTOR IA (ANCORADO NA SIDEBAR PARA NÃO PISCAR) */
    .betano-header { 
...
# --- [HEADER DENTRO DA SIDEBAR - A SOLUÇÃO DO PISCAR] ---
with st.sidebar:
    st.markdown("""
...
# --- [DADOS DE HIERARQUIA ORIGINAIS RESTAURADOS] ---
DADOS_HIEARARQUIA = {
...
# --- [CONTEÚDO DINÂMICO - RECONSTRUÇÃO TOTAL] ---
