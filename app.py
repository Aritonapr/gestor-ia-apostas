...
# 3. SIDEBAR E HEADER
with st.sidebar:
    st.markdown("""<div class="betano-header"><div class="logo-link">GESTOR IA</div><div style="display:flex;"><div class="nav-item">AO VIVO</div><div class="nav-item">ESTATÍSTICAS</div></div></div><div style="height:65px;"></div>""", unsafe_allow_html=True) 
