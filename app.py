...
st.markdown("""
    ...
    /* [ESTABILIZADOR] FORÇA O NAVEGADOR A MANTER AS CORES MESMO DURANTE O RECARREGAMENTO */
    :root {
        --header-bg: #002366;
    }
    ...
    /* ESCONDE A BARRA NATIVA QUE FICA PISCANDO NO TOPO */
    header, [data-testid="stHeader"] { 
        display: none !important; 
        height: 0px !important;
    }
    
    /* TRAVA O HEADER FIXO NO LUGAR COM PRIORIDADE MÁXIMA */
    .betano-header { 
