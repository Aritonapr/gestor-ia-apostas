...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v75.00 - VERSÃO ESTÁVEL FINAL]
# ==============================================================================
...
# 2. CAMADA DE ESTILO CSS (ZERO WHITE REFORÇADO v57.35)
st.markdown("""
    <style>
    ...
    * { -ms-overflow-style: none !important; scrollbar-width: none !important; }
    ...
    .registrar-pill { color: #ffffff; font-size: 9px; font-weight: 800; border: 1.5px solid #ffffff; padding: 6.5px 18px; border-radius: 20px; }
    ...
    .bilhete-master { 
        ...
        max-width: 460px; margin: 0 auto; border-top: 10px solid #9d54ff; 
    ...
    .market-badge { background: #f1f5f9; padding: 2px 8px; border-radius: 4px; font-weight: 800; color: #6d28d9; font-size: 10px; }
...
if st.session_state.aba_ativa == "home":
    ...
    with c4: draw_card("SISTEMA", "JARVIS v75.00", 100)
    ...
    if df_diario is not None and not df_diario.empty:
        ...
        <div class="bilhete-master">
            <div style="text-align:center; border-bottom:1px solid #eee; padding-bottom:10px; margin-bottom:15px;">
                ...
                <span style="font-size:10px; color:#666;">GERADO EM: {datetime.now().strftime('%d/%m/%Y %H:%M')}</span>
            </div>
        """
        for _, row in top_20.iterrows():
            bilhete_html += f"""<div class="ticket-row"><span>{row['TIME_CASA']} x {row['TIME_FORA']}</span><span class="market-badge">OVER 1.5</span></div>"""
        bilhete_html += "</div>"
    ...
    st.info("Módulo em processamento. Os dados aparecerão em instantes.")

st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | v75.00</div><div>JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
