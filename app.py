...
# --- [FUNÇÃO PARA MUDAR DE ABA SEM PISCAR] ---
...
# 2. ESTILOS CSS (ESTABILIZADOS)
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700;900&display=swap');
    
    /* FIXADOR DE FUNDO: EVITA FLASH BRANCO */
    html, body, [data-testid="stAppViewContainer"], [data-testid="stHeader"], .stApp {
        background-color: #0b0e11 !important;
        font-family: 'Inter', sans-serif;
    }

    /* REMOVE BARRA DE CARREGAMENTO E ELEMENTOS NATIVOS QUE CAUSAM PISQUE */
    [data-testid="stHeader"] { display: none !important; }
    #stProgress { display: none !important; }
    div.stSpinner > div { border-top-color: #6d28d9 !important; }
    ...
    /* HEADER FIXO - GESTOR IA (REFORÇADO) */
    .betano-header { 
...
# --- [SIDEBAR NAVEGAÇÃO - COM CALLBACK PARA EVITAR PISCAR] ---
with st.sidebar:
