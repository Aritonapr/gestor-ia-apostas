...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v70.00 - RESTAURAÇÃO TOTAL DE HEADER E BOTÕES]
# ==============================================================================
...
# 2. CAMADA DE ESTILO CSS (RESTAURAÇÃO COMPLETA v57.35)
st.markdown("""
    <style>
    ...
    * { -ms-overflow-style: none !important; scrollbar-width: none !important; }
    ...
    /* HEADER SUPERIOR FIXO - RECONSTRUÍDO */
    .betano-header { 
    ...
    .nav-item { color: #ffffff !important; font-size: 10px !important; text-transform: uppercase; font-weight: 600 !important; cursor: pointer; white-space: nowrap; opacity: 0.8; }
...
# 3. HEADER HTML (FORA DA SIDEBAR PARA NÃO SUMIR)
st.markdown("""
...
if st.session_state.aba_ativa == "home":
    ...
    with c4: draw_card("SISTEMA", "JARVIS v70.00", 100)
    ...
    else: st.error("Aguardando carregamento de jogos pelo robô...")

else:
    st.markdown(f"<h2 style='color:white;'>{st.session_state.aba_ativa.upper()}</h2>", unsafe_allow_html=True)
    st.info("Módulo em desenvolvimento. As informações aparecerão assim que a IA processar os dados.")

st.markdown("""<div class="footer-shield"><div>STATUS: ● IA OPERACIONAL | v70.00</div><div>JARVIS PROTECT</div></div>""", unsafe_allow_html=True)
