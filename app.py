...
# ==============================================================================
# [PROTOCOLO DE MANUTENÇÃO v57.24 - FOCO EM LEGIBILIDADE]
# ==============================================================================
...
if 'aba_active' not in st.session_state: st.session_state.aba_active = "home"
...
# 2. CSS INTEGRAL (AJUSTE DE CONTRASTE E LEITURA NO MENU)
st.markdown("""
    <style>
    ...
    * { -ms-overflow-style: none !important; scrollbar-width: none !important; }
    ...
    /* HEADER E MENU SUPERIOR - AJUSTE DE CLAREZA */
    .betano-header { 
    ...
    /* ESTILO DAS PALAVRAS DO MENU (LIMPO E LEGÍVEL) */
    .nav-item { 
        color: #ffffff !important; 
        font-size: 11px !important; /* Aumentado para facilitar leitura */
        text-transform: uppercase; 
        opacity: 1 !important; /* Brilho total para não forçar a vista */
        font-weight: 600; 
    ...
    .registrar-pill { 
        color: #ffffff !important; font-size: 10px !important; font-weight: 800; 
...
with st.sidebar:
    ...
    if st.button("📡 SCANNER EM TEMPO REAL"): st.session_state.aba_active = "live"
    if st.button("💰 GESTÃO DE BANCA"): st.session_state.aba_active = "gestao"
    if st.button("📅 JOGOS DO DIA"): st.session_state.aba_active = "home"
    if st.button("⚽ APOSTAS POR GOLS"): st.session_state.aba_active = "gols"
    if st.button("🚩 APOSTAS POR ESCANTEIOS"): st.session_state.aba_active = "escanteios"
...
# LÓGICA SIMPLES DE TELAS (EXEMPLO HOME)
if st.session_state.aba_active == "home":
    ...
    st.info(f"TELA {st.session_state.aba_active.upper()} CARREGADA COM SUCESSO.")
